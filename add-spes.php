					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-form">
								<form action="spes" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<input id="tgl_bln_thn_dipa" name="tgl_bln_thn_dipa" type="date" class="form-control input-border-bottom" required="">
										</div>
									</div>
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jmlh_penawaran" name="harga_satuan" type="text" class="form-control input-border-bottom" required="">
